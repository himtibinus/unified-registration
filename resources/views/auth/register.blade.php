                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}<b
                        ...
                        ?>
                        <div class="form-group row">
                            <label for="university_id" class="col-md-4 col-form-label text-md-right">University<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                                <select class="form-control" id="university_id" name="university_id"
                                    onChange="checkBinusian()">
                                    <option value="1" {{ old('university_id') == '1' ? 'selected' : '' }}>
                        ...
                        <div class="alert alert-info" role="alert">
                            <b>For BINUSIAN participants:</b> Make sure to select <b>BINUS University</b> to be eligible for
                            <a href="https://student.binus.ac.id/sat/" target="_blank">Student Activity Transcript (SAT)</a>
                            points. Use <b>@binus.ac.id</b> email address whenever possible.
                        </div>
                        <div class="alert alert-warning" role="alert">
                            <b>For PPTI BCA participants at TECHNO 2022:</b> Make sure to select <b>BINUS University</b> and
                            select <b>PPTI BCA</b> as your campus location.
                        </div>
                        <div class="form-group row" id="nim-container">
                            <label for="nim" class="col-md-4 col-form-label text-md-right">{{ __('NIM') }}<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                                <input id="nim" type="number" class="form-control @error('nim') is-invalid @enderror"
                                    name="nim" value="{{ old('nim') }}" placeholder="2xxxxxxxxx">
                        ...
                        <div class="form-group row" id="binus_regional-container">
                            <label for="binus_regional" class="col-md-4 col-form-label text-md-right">Campus<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row" id="fyp_batch-container">
                            <label for="fyp_batch" class="col-md-4 col-form-label text-md-right">FYP batch (for TECHNO
                                events)<b class="text-danger">*</b></label>
                            <div class="col-md-6">
                                <select class="form-control" id="fyp_batch" name="fyp_batch">
                                    <option value="0">None</option>
                                    <option value="1 (AAS, ABN, ABM, PPTI)">1 (AAS, ABN, ABM, ABB, PPTI)</option>
                                    <option value="2 (BAS, BBN, ABB, BBM)">2 (BAS, BBN, BBB, BBM)</option>
                                    <option value="3 (CAS, CBN, BBB, CBM, ASG)">3 (CAS, CBN, CBB, CBM, ASG)</option>
                                    <option value="4 (DAS, DBN, CBB, BSG)">4 (DAS, DBN, BSG)</option>
                                    <option value="5 (EAS, EBN, ASN)">5 (EAS, EBN, ASN)</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row" id="new_university-container">
                            <label for="new_university"
                                class="col-md-4 col-form-label text-md-right">{{ __('University Name') }}<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                                <input id="new_university" type="text"
                                    class="form-control @error('new_university') is-invalid @enderror"
                                    name="new_university" value="{{ old('new_university') }}">
                        ...
                        <div class="form-group row">
                            <label for="major"
                                class="col-md-4 col-form-label text-md-right">{{ __('Major / study program') }}<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                                <input id="major" type="text"
                                    class="form-control @error('major') is-invalid @enderror" name="major"
                                    value="{{ old('major') }}" list="major-recommendations"
                                    placeholder="Your major/ study program">
                                @error('major')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="alert alert-success" role="alert">
                            <b>For BINUS University students, please use your full program names</b> such as <b><i>Computer
                                    Science and Mathematics</i></b> instead of <b><i>TI MAT</i></b> (may be confused with
                            <b><i>Mobile Application and Technology - MAT</i></b>), or <b><i>Computer Science Global
                                    Class</i></b> instead of <b><i>IT GC</i></b>.
                        </div>
                        <div class="alert alert-info" role="alert">
                            <b>BINUS International Computer Science</b> and <b>PPTI BCA</b> students may select <b>Computer
                                Science (Regular)</b> as their major / study program.
                        </div>
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="email"
                                class="col-md-4 col-form-label text-md-right">{{ __('Email address') }}<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="phone"
                                class="col-md-4 col-form-label text-md-right">{{ __('Phone number') }}<b
                                    class="text-danger">*</b></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="line"
                                class="col-md-4 col-form-label text-md-right">{{ __('LINE registered number or LINE ID') }}</label>
                            <div class="col-md-6">
                                <input id="line" type="text"
                                    class="form-control @error('line') is-invalid @enderror" name="line"
                                    value="{{ old('line') }}" autocomplete="tel"
                                    placeholder="Your LINE registered number or LINE ID">
                                @error('line')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="whatsapp"
                                class="col-md-4 col-form-label text-md-right">{{ __('WhatsApp registered number') }}</label>
                            <div class="col-md-6">
                                <input id="whatsapp" type="text"
                                    class="form-control @error('whatsapp') is-invalid @enderror" name="whatsapp"
                                    value="{{ old('whatsapp') }}" autocomplete="tel"
                                    placeholder="Your WhatsApp registered number">
                                @error('whatsapp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

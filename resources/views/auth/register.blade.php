                        ...
                        <div class="form-group row" id="fyp_batch-container">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="fyp_batch" name="fyp_batch">
                                    ...
                                    <option value="2 (BAS, BBN, ABB, BBM)">2 (BAS, BBN, ABB, BBM)</option>
                                    <option value="3 (CAS, CBN, BBB, CBM, ASG)">3 (CAS, CBN, BBB, CBM, ASG)</option>
                                    <option value="4 (DAS, DBN, CBB, BSG)">4 (DAS, DBN, CBB, BSG)</option>

...
<?php
    ...
    $registeredEvents = DB::table('registration')->select('registration.id', 'registration.event_id', 'registration.remarks', 'registration.status', 'events.*')->join('events', 'events.id', 'registration.event_id')->where('ticket_id', Auth::id())->get();
    $registeredEventIDs = [];
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            @elseif(count($registeredEvents) == 0)
                <div class="card mb-4">
                    <div class="card-header h4 bg-danger text-white">{{ __('You currently haven\'t registered to any new events yet.') }}</div>
                    <div class="card-body">
